  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <!-- /.card-header -->
       <form action="{{route('store.blog')}}" method="post" class="forms-sample"  enctype="multipart/form-data">
                       	@csrf
        <div class="card-body">
          <div class="row">
...
@endphp
          ...
          <div class="col-md-6">
           <div class="form-group">
                ...
                <textarea class="form-control" name="short" id="summernote"></textarea>
          ...
          <div class="col-md-6">
           <div class="form-group">
                ...
                <select class="form-control" name="slider_blog" required>
