  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <div class="card card-default">
        ...
        <!-- /.card-header -->
       <form action="{{route('update.client',$client->id)}}" method="post" class="forms-sample"  enctype="multipart/form-data">
                       	@csrf
        <div class="card-body">
          <div class="row">
...
@endphp
          <div class="col-md-6">
           <div class="form-group">
                ...
                <select class="form-control" name="client_category_id" required="">
                  ...
                  <option value="{{ $row->id }}" {{ $row->id == $client->client_category_id ? 'selected' : '' }}>{{ $row->name }}</option>
                  @endforeach
                </select>
          ...
          <div class="col-md-6">
           <div class="form-group">
             ...
             <img id="logo" src="{{asset('backend/client/'.$client->image) }}" width="50" height="50;" />
          </div>
      </div>
